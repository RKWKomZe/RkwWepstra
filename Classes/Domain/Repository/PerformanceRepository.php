...
class PerformanceRepository extends \TYPO3\CMS\Extbase\Persistence\Repository
{
     ...
     * @return void
     */
    public function removeHard(\RKW\RkwWepstra\Domain\Model\Performance $performance)
    {

        $GLOBALS['TYPO3_DB']->sql_query("
			DELETE FROM tx_rkwwepstra_domain_model_performance
			WHERE uid = " . intval($performance->getUid()) . "
		");
    }
