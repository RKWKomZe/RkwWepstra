...
$GLOBALS['TCA']['tx_rkwwepstra_domain_model_geographicalsector'] = array(
	'ctrl' => array(
		'hideTable' => 1,
		'title'	=> 'LLL:EXT:rkw_wepstra/Resources/Private/Language/locallang_db.xlf:tx_rkwwepstra_domain_model_geographicalsector',
		'label' => 'title',
		'tstamp' => 'tstamp',
		'crdate' => 'crdate',
		'cruser_id' => 'cruser_id',
		...
		'iconfile' => 'EXT:rkw_wepstra/Resources/Public/Icons/tx_rkwwepstra_domain_model_geographicalsector.gif'
	),
	'interface' => array(
	...
	'columns' => array(
		...
		'title' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:rkw_wepstra/Resources/Private/Language/locallang_db.xlf:tx_rkwwepstra_domain_model_geographicalsector.title',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
		...
		'description' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:rkw_wepstra/Resources/Private/Language/locallang_db.xlf:tx_rkwwepstra_domain_model_geographicalsector.description',
			'config' => array(
				'type' => 'text',
				'cols' => 40,
				'rows' => 15,
		...
		'value' => array(
			'exclude' => 1,
			'label' => 'LLL:EXT:rkw_wepstra/Resources/Private/Language/locallang_db.xlf:tx_rkwwepstra_domain_model_geographicalsector.value',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
